...
<template>
  <div class=''>
    ...
    <div class="addBtn">
      <el-button type="primary" size="mini" @click="toAdd">添加文章</el-button>
    </div>
    ...
    <div class="tableBox">
      ...
      >
        ...
        <el-table-column prop="category" label="文章分类" min-width="120" :formatter="categoryFormatter"></el-table-column>
...
import getArticleCategory from '@/views/message/mixins/getArticleCategory'
import searchForm from '@/components/searchForm'

export default {
  mixins: [getArticleCategory],
    ...
    formOptions () {
      return [
        ...
        },
        {
          ...
          prop: 'category',
          element: 'el-select',
          options: this.getArticleCategory()
        },
        {
          label: '时间',
          prop: 'timeRange',
  ...
  methods: {
    ...
    categoryFormatter (row, column) {
      return this.getArticleCategory(row.category)
    }
  },
