...
<template>
  <div class="handleActivityCard">
    ...
    <el-form class="formContainer" :rules="rules" :model="formData" ref="formRef" label-width="140px">
      ...
      <!-- radio选择框 -->
      <el-form-item label="card位置:" prop="cardClassify">
        <el-radio-group v-model="formData.cardClassify">
          <el-radio label="左侧竖图"></el-radio>
          <el-radio label="右侧横图-上"></el-radio>
          <el-radio label="右侧横图-下"></el-radio>
        </el-radio-group>
      </el-form-item>
