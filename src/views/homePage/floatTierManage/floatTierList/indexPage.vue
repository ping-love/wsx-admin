      ...
      <div class="tableBox">
        ...
        >
          ...
          <el-table-column
            prop="linkType"
            label="链接类型"
            :formatter="linkCategoryFormatter"
...
export default {
  ...
  methods: {
    ...
    linkCategoryFormatter (row, column) {
      return getLinkCategory(row.linkType)
    },
    // 搜索
    handleSearch (data) {
    ...
    handleEdit (index, row) {
      ...
      setTimeout(() => {
        this.$router.push({ name: 'EditFloatTier' })
      }, 1000)
    },
    // 删除处理
    handleDelete (index, row) {
      console.log('删除:', index, row)
      this.$confirm('是否确认删除商品楼层?', '提示', {
