      ...
      <div class="tableBox">
        ...
        >
          ...
          <el-table-column
            ...
            :min-width="minWidths.recommendTypeWid"
          ></el-table-column>
          <el-table-column
            label="底图"
...
export default {
  ...
  methods: {
    categoryFormatter (row, column) {
      return getRecommendCategory(row.recommendType)
    },
    // 搜索
    handleSearch (data) {
