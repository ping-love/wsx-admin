  ...
  <div class='returnMoney'>
    ...
    <div class="listWrap">
      <el-table :data="tableData" tooltip-effect="dark" style="width: 100%">
        ...
        <el-table-column prop="explain" label="退款说明" min-width="130"></el-table-column>
        <el-table-column class="explainImg" prop="explainImg" label="退款说明图片" min-width="150">
          <template slot-scope="scope">
            <el-image
...
import { getApplyStatus } from '@/filters/transformTwo'
...
export default {
  ...
  methods: {
    ...
    handleStatusFormatter (row, column) {
      console.log(row.handleStatus)
      return getApplyStatus(row.handleStatus)
    },
    handleSearch (data) {
